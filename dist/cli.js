...
async function main() {
    ...
    console.log("Done.");
    console.log(`added=${stats.added} updated=${stats.updated} markedDeleted=${stats.markedDeleted} unchanged=${stats.unchanged}`);
}
main().catch((error) => {
